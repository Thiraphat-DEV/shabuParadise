...
<html lang="en">
  ...
  <head>
    ...
    <title>Booking Shabuparadise</title>
  ...
  <body>
    ...
    <header class="">
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          <a class="navbar-brand" href="index.html"><h2>Booking <em>Shabuparadise</em></h2></a>
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="products.html">เกี่ยวกับสินค้า</a>
              </li>
              <li class="nav-item">
